 ...
 * @npmpackage
 * @class DateSchedule
 * @desc This class creates a schedule of dates that will be compared agains the currentdate/time. There are 2 ways to use
...
import { MathUtils, TextUtils } from 'ad-utils'
...
export default function DateSchedule(arg) {
	...
	D.addDate = function(tzDate, label, callback) {
		...
		if (typeof label === 'function') {
			...
			let labelToPass = standardKey
				? standardKey == 'WEEK'
					? labelOG.call(D, dateToPass)
					: DateFormatter.getLabels()[standardKey]
				: null
