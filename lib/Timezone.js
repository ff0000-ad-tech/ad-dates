/**
	...
	@desc
		...
		<table>
			<tr><td>US/Eastern</td><td>	
			<tr><td>US/Central</td><td>	
			<tr><td>US/Mountain</td><td>	
			<tr><td>US/Pacific</td><td>	
			<tr><td>US/Alaska</td><td>	
			<tr><td>US/Arizona</td><td>	
			<tr><td>US/Hawaii</td><td>	
			<tr><td>Australia/Brisbane</td><td>	
			<tr><td>Australia/Sydney</td><td>	
			<tr><td>America/Mexico_City</td><td>	
			<tr><td>America/Bogota</td><td>	
			<tr><td>America/Argentina/Buenos_Aires</td><td>			
		</table>
*/
...
export function setLocal(val) {
	...
	// console.console.log( 'hr:', hr, 'min:', min, '| adjHr:', adjHr, 'adjMin:', adjMin, '|val:', val )
	_tzDiff[0] = adjHr
	_tzDiff[1] = adjMin
...
function getByAbbr(timezone) {
	...
	for (let item in dict) {
		...
		// console.log('\t -->', item, dict[item], abbrs, timezone, tzLc, abbrs.includes(tzLc))
