...
/**
	...
	@desc
		...
		<table>
			<tr><td>YYYY</td>	<td>Year as full Number: 2018</td></tr>
			<tr><td>YY</td>		<td>Year as abbreviated Number: 18</td></tr>
			<tr><td>MMMM</td>	<td>Month as full String: September</td></tr>
			<tr><td>MMM</td>	<td>Month as abbreviated String: sept</td></tr>
			<tr><td>MM</td>		<td>Month as full Number: 08, 09, 10, 11</td></tr>
			<tr><td>M</td>		<td>Month as shortest Number: 8, 9, 10, 11</td></tr>
			<tr><td>DDDD</td>	<td>Day of the week as full String: Monday</td></tr>
			<tr><td>DDD</td>	<td>Day of the week as abbreviated String: mon</td></tr>
			<tr><td>DD</td>		<td>Date as full Number: 08, 09, 10, 11</td></tr>
			<tr><td>D</td>		<td>Date as shortest Number: 8, 9, 10, 11</td></tr>
			<tr><td>o</td>		<td>Date Suffix String: st, nd, rd, th</td></tr>
			<tr><td>Do</td>		<td>Date AND Suffix as Number/String: 1st, 2nd, 3rd, 4th</td></tr>
			<tr><td>TT</td>		<td>Time (Hour:Minute) in full military time as String: 19:00, 20:15</td></tr>
			<tr><td>T</td>		<td>Time (Hour:Minute) in shortest military time as String: 19, 20:15</td></tr>
			<tr><td>tt</td>		<td>Time (Hour:Minute) in full standard time as String: 7:00, 8:15</td></tr>
			<tr><td>t</td>		<td>Time (Hour:Minute) in shortest standard time as String: 7, 8:15</td></tr>
			<tr><td>HH</td>		<td>Hour in full military time as Number: 0...23 > 08, 09, 10, 20, 21</td></tr>
			<tr><td>H</td>		<td>Hour in shortest military time as Number: 0...23 > 8, 9, 10, 20, 21</td></tr>
			<tr><td>hh</td>		<td>Hour in full standard time as Number: 1...12 > 08, 09, 10, 11</td></tr>
			<tr><td>h</td><		td>Hour in shortest standard time as Number: 1...12 > 8, 9, 10, 11</td></tr>
			<tr><td>mm</td>		<td>Minute in full standard time as Number: 0...59 > 08, 09, 10, 11</td></tr>
			<tr><td>m</td>		<td>Minute in shortest standard time as Number: 0...59 > 8, 9, 10, 11</td></tr>
			<tr><td>ss</td>		<td>Second in full standard time as Number: 0...59 > 08, 09, 10, 11</td></tr>
			<tr><td>s</td>		<td>Second in shortest standard time as Number: 0...59 > 8, 9, 10, 11</td></tr>
			<tr><td>a</td>		<td>Meridiem as String: am, pm</td></tr>
			<tr><td>z</td>		<td>Timezone abbreviation as String: pt, mt, ct, et</td></tr>
			<tr><td>^</td>		<td>Special Character - add to the end of any token will run toUpperCase() the return as String: ${Do} = 1st, ${Do^} = 1ST</td></tr>						
		</table>
