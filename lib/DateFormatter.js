...
/**
	...
	@desc
		Changes the language used for date formatting. NOTE: This is initally set from {@link DateManager}.init
	<codeblock>
 ...
 * @returns {TzDate|Date}
 * @desc Returns an objects that defines labels that date-messaging will use in the ad, used directly by DateSchedule & RecurringSchedule
 */
 ...
 * @returns {String}
 * @desc Returns the numeric suffix, eg. st, nd, rd, th in the language set from {@link DateManager}
 * @example
 ...
 * @returns {String}
 * @desc Formats a TzDate in any possible mutation by accepting tokens and strings<br>
