 ...
 * @npmpackage
 * @class TzDate
 * @desc This class is a wrapper for the Javascript "Date" object.
 * <br><br>
...
function TzDate(args) {
	...
	Object.defineProperties(T, {
		 ...
		 * @desc Getter|Setter : Change the timezone that all methods will default return the date/time in. Does NOT change the date, just how it is output.
		 * @example
		 * // get
	 ...
	 * @memberOf TzDate
	 * @method getHoursIn
	 * @desc Similar to Date.getHours(), but this will return the hours in a specified timezone,
	 ...
	 * @memberOf TzDate
	 * @method format
	 * @desc Direct usage of DateFormatter.format()
	 * @returns {String}
	 ...
	 * @memberOf TzDate
	 * @method getIn
	 * @desc If you need the actual TzDate object with the adjust time applied. <br><span style="color:#ff0000">WARN: This will return a TzDate
	 ...
	 * @memberOf TzDate
	 * @method print
	 * @desc Is a shorthand for .toFullDateTime()
	 * @returns {string}
	 * @property {object|string|number} inTimezone
	 ...
	 * 		The timezone at which you would like the TzDate printed out as, defaults to outputTimezone.
	 * @returns {string}
	 * @desc Returns a string in the format of "Weekday Mon DD YYYY HH:MM:SS Timezone"
	 */
	 ...
	 * 		The timezone at which you would like the TzDate printed out as, defaults to outputTimezone.
	 * @returns {string}
	 * @desc Returns a string in the format "MM/DD"
	 */
	 ...
	 * 		The timezone at which you would like the TzDate printed out as, defaults to outputTimezone.
	 * @returns {string}
	 * @desc Returns a string in the format "MM/DD/YYYY"
	 */
	T.toDate = inTimezone => {
		const tzDate = T.getIn(inTimezone)
	 ...
	 * 		The timezone at which you would like the TzDate printed out as, defaults to outputTimezone.
	 * @returns {string}
	 * @desc Returns a string in the format "MM/DD/YYYY HH:MMa/p"
	 */
	 ...
	 * 		The timezone at which you would like the TzDate printed out as, defaults to outputTimezone.
	 * @returns {string}
	 * @desc Returns a string in the format "MM/DD HH:MM"
	 */
	 ...
	 * 		The timezone at which you would like the TzDate printed out as, defaults to outputTimezone.
	 * @returns {string}
	 * @desc Returns a string in the format "HH:MM AM/PM"
	 */
	T.toTime = inTimezone => {
	 ...
	 * 		Whether the hours should be in military 24 hour or standard 12 hour. true = base 24, false = base 12. Default is false.
	 * @returns {string}
	 * @desc Returns a string in the format "HH:MM"
	 * @example
	 * myDate.toSimpleTime()
	 ...
	 * @returns {string}
	 * @desc Returns the meridiem "am", "pm" or "am/et", "am/et"
	 * @example
	 * myDate.toMeridiem();
	 * // returns "am" or "pm"
	 *
	 ...
	 * 		Whether the hours should be in military 24 hour or standard 12 hour. true = base 24, false = base 12. Default is false.
	 * @returns {string}
	 * @desc Returns a string in the format "HH:MM", but if there are no minutes will return "HH"
	 */
