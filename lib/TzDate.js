...
import { pad } from 'ad-utils/lib/TextUtils.js'
...
function TzDate(args) {
	...
	} else if (DateManager.defaultTimezone) {
		_outputTimezone = DateManager.defaultTimezone
	...
	*/
	T.toSimpleTime = (inTimezone, inMilitary) => {
		...
		return hours + ':' + pad(tzDate.getMinutes(), 2)
	}
	...
	*/
	...
	T.toDateTimeISO = inTimezone => {
		...
		let month = pad(dateSplit[0], 2)
		let day = pad(dateSplit[1], 2)
