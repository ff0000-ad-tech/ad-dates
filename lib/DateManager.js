...
export function init(args = {}) {
	...
	let externalDate = getQueryParams('date')
	...
	if (_currentDate) {
		...
		let externalTzLabel = getQueryParams('tz')
		if (externalTzLabel) {
			tz = externalTzLabel
		}
	}
	...
	let externalDefaultTimezone = getQueryParams('ltz')
...
export function setDefaultTimezone(val) {
	if (val) {
		...
		console.log('\tdefaultTimezone:', _defaultTimezone)
	}
}
