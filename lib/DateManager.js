...
// TEMP: Timezone treeshake optimization needs to be figured out
class DateManager {
	static Timezone = new TZ()
	static _currentDate
	...
	*/
	static getNow() {
		...
		return new TzDate({
			datetime: date,
			outputTimezone: this.Timezone.LOCAL
		})
	}
