 ...
 * @npmpackage
 * @class DateManager
 * @desc This class initailizes the ads understanding of "now" for use with all other Date oriented classes.
 * <br><br>
 ...
 * @method init
 * @desc This function is meant to be called at the very beginning of the ad's lifespan. Automatically, it sets initial time which
 ...
 * @method getNow
 * @returns {TzDate}
 * @desc Returns a TzDate representing the exact time it is called.<br>You can override system time in the following ways:
 * @example
 * // in the index
 * var adParams = {
 * 	dateSettings: {
